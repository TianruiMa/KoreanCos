...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //设置进度条颜色
        [self setTintColor:UIColorFromRGB(0xA82674)];
...
-(void)setProgressFrame:(float)height{

    [self.progressView setFrame:CGRectMake(0, height, self.frame.size.width, self.progressView.frame.size.height)];
